...
public class TicketMasterClient {
	...
	private static final String API_KEY = "jOWVSaKULNFdiDElNeSz7OF56iufu0PV";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s",
				API_KEY,geoHash, keyword, DEFAULT_RADIUS);
		...
		try {
			...
			// The HttpUrlConnection class allows us to 
...
//	}
	...
	// helper methods
	// Fetch address form event JSONObj
